...
- 修复设置页主题选择和 AI 生图厂商按钮乱码，主题显示为“明亮 / 暗色 / 系统”，生图厂商显示为“星境 AI / 多米 AI”。
- “给 Ta 的信”在积分不足或权限不足时会给出明确提示和引导，不再出现无积分也安排发送的情况。
- 客户端更新提醒只在新版已提交时展示，避免把普通服务端维护误认为客户端新版升级。
- 网址导航官方导航卡片显示提交人昵称、浏览次数和收藏数量，便于判断网址来源和热度。
- 继续优化剪切板文件/目录复制、图片预览、心迹海报查看、数据迁移和本地备份体验。
